            ...
            <div className="col-lg-12">
              <div className="hero-content">
                ...
                <p className="hero-subtitle">
                  Get in touch with Tirumala Tirupati Devasthanams
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="row">
            <div className="col-lg-12">
              <div className="text-center mb-5">
                ...
                <p className="text-muted">
                  Reach out to specific departments for dedicated assistance
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="col-lg-8 mx-auto">
              <div className="accordion" id="faqAccordion">
                <div className="accordion-item">
                  ...
                  >
                    <div className="accordion-body">
                      You can book darshan tickets through our official website
                      by creating an account, selecting your preferred date and
                      time, and making secure online payment.
                    </div>
                  </div>
                </div>
                ...
                <div className="accordion-item">
                  ...
                  >
                    <div className="accordion-body">
                      The temple is open from early morning (around 2:30 AM)
                      until late night (around 1:00 AM). General darshan is
                      available from 8:00 AM to 7:00 PM.
                    </div>
                  </div>
                </div>
                ...
                <div className="accordion-item">
                  ...
                  >
                    <div className="accordion-body">
                      Accommodation can be booked online through our website or
                      by calling our booking helpline. You can also visit our
                      booking counters at the temple premises.
                    </div>
                  </div>
                </div>
                ...
                <div className="accordion-item">
                  ...
                  >
                    <div className="accordion-body">
                      Photography is not allowed inside the main sanctum and
                      certain restricted areas. However, you can take photos in
                      permitted areas of the temple complex.
                    </div>
                  </div>
                </div>
              </div>
